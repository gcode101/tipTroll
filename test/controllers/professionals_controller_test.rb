...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { email: @professional.email, job_location: @professional.job_location, job_title: @professional.job_title, name: @professional.name, password_digest: @professional.password_digest, phone_number: @professional.phone_number }
    end
  ...
  test "should update professional" do
    patch :update, id: @professional, professional: { email: @professional.email, job_location: @professional.job_location, job_title: @professional.job_title, name: @professional.name, password_digest: @professional.password_digest, phone_number: @professional.phone_number }
    assert_redirected_to professional_path(assigns(:professional))
  end
